...
void _Repeatedly_puts_(int sleepTime, int frequency, char call[],
                       char callAgain[], char callAgainAndAgain[]);
...
int _For_puts_(int startNum, int mode, int endObjective, int addStartNum,
               char call[]);
