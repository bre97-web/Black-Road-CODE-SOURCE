...
void userLogin(void) {
  ...
  if (userAddress.userAddress[0] == '0') {
    ...
    _Console_Write_Repeatedly(100,userAddress.localUserAddressFolder,userAddress.localUserAddressData_DataFile,userAddress.localuserAddressData_AchievementFile);
